function solution(new_id) {
  ...
  // new_id가 a라면 // new_id = a + a.repeat(2) // new_id = aaa
  // new_id가 aa라면 // new_id = aa + a[1].repeat(1) // new_id = aaa

  return new_id;
}

console.log(solution("...!@BaT#*..y.abcde4fghijklm6"));
